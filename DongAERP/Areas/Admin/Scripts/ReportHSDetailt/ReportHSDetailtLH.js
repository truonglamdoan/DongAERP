...
$(document).ready(function () {
    ...
    Report.MarketForOne();
    Report.MarketForOneForMonth();
    Report.MarketForOneForYear();
...
var Report = new function () {
     ...
     * @since[Trường Lãm] created on [15/06/2020]
     */
    this.MarketForOneForYear = function () {
    ...
    this.onSelectMarketID = function (e) {
        ...
        if (dataItem != null) {
            ...
            // grid bảng số liệu
            let urlGridDS = "/Admin/ReportHSDetailtLHType/SearchReportDetailtCompareMonthForOne?month=";
            ...
            urlGridDS = "/Admin/ReportHSDetailtLHType/SearchReportDetailtCompareMonthForOneCompare?month=";
            ...
            let urlChartDS = "/Admin/ReportHSDetailtLHType/SearchColumnChartCompareMonthStackForOne?month=";
            ...
            urlChartDS = "/Admin/ReportHSDetailtLHType/SearchColumnsChartCompareMonthForOneDSCK?month=";
            chart.dataSource.transport.options.read.data = '';
            chart.dataSource.transport.options.read.url = urlChartDS + month + "&year=" + year + "&reportTypeID=" + valueReportType + "&marketID=" + dataItem.Value;
            chart.options.title.text = kendo.format("Doanh số các đối tác thị trường {0}", dataItem.Text);
            //chart.options.categoryAxis[1].categories = [lastYear, lastMonth, monthYear];
            ...
            urlChartDS = "/Admin/ReportHSDetailtLHType/SearchColumnsChartCompareMonthForOneDSChiNha?month=";
            chart.dataSource.transport.options.read.data = '';
            chart.dataSource.transport.options.read.url = urlChartDS + month + "&year=" + year + "&reportTypeID=" + valueReportType + "&marketID=" + dataItem.Value;
            chart.options.title.text = kendo.format("Doanh số các đối tác thị trường {0}", dataItem.Text);
            //chart.options.categoryAxis[1].categories = [lastYear, lastMonth, monthYear];
            ...
            urlChartDS = "/Admin/ReportHSDetailtLHType/SearchColumnsChartCompareMonthForOneDSChiQuay?month=";
            chart.dataSource.transport.options.read.data = '';
            chart.dataSource.transport.options.read.url = urlChartDS + month + "&year=" + year + "&reportTypeID=" + valueReportType + "&marketID=" + dataItem.Value;
            chart.options.title.text = kendo.format("Doanh số các đối tác thị trường {0}", dataItem.Text);
            //chart.options.categoryAxis[1].categories = [lastYear, lastMonth, monthYear];
            ...
            urlChartDS = "/Admin/ReportHSDetailtLHType/SearchDataCompareMonthPieLastYear?month=";
            chart.dataSource.transport.options.read.data = '';
            chart.dataSource.transport.options.read.url = urlChartDS + month + "&year=" + year + "&reportTypeID=" + valueReportType + "&marketID=" + dataItem.Value;
            ...
            urlChartDS = "/Admin/ReportHSDetailtLHType/SearchDataCompareMonthPieLastMonth?month=";
            chart.dataSource.transport.options.read.data = '';
            chart.dataSource.transport.options.read.url = urlChartDS + month + "&year=" + year + "&reportTypeID=" + valueReportType + "&marketID=" + dataItem.Value;
            ...
            urlChartDS = "/Admin/ReportHSDetailtLHType/SearchDataCompareMonthPieYear?month=";
            chart.dataSource.transport.options.read.data = '';
            chart.dataSource.transport.options.read.url = urlChartDS + month + "&year=" + year + "&reportTypeID=" + valueReportType + "&marketID=" + dataItem.Value;
            ...
            urlGridDS = "/Admin/ReportHSDetailtLHType/SearchDataDetailtGridCompareMonthPercent?month=";
    ...
    this.onSelectGradationMarketID = function (e) {
        ...
        if (dataItem != null) {
            ...
            let urlGrid = "/Admin/ReportHSDetailtLHType/SearchGridReportForGradationForOne?Gradation=";
            grid.dataSource.transport.options.read.data = '';
            ...
            let urlGridCompare = "/Admin/ReportHSDetailtLHType/SearchGridReportForGradationForOneCompare?Gradation=";
            ...
            urlGridCompare = "/Admin/ReportHSDetailtLHType/SearchDataDetailtGridGradationComparePercent?gradation=";
            gridCompare.dataSource.transport.options.read.data = '';
            gridCompare.dataSource.transport.options.read.url = urlGridCompare + gradationDicID + "&year=" + toYear + "&reportTypeID=" + valueReportType + "&marketID=" + dataItem.Value;
            gridCompare.dataSource.read();
            ...
            let urlChartPieProportion = "/Admin/ReportHSDetailtLHType/SearchColumnChartGradationCompareStackForOne?gradation=";
            ...
            let urlChartDS = "/Admin/ReportHSDetailtLHType/SearchColumnsChartGradationCompareForOneForDSChiQuay?gradation=";
            ...
            urlChartDS = "/Admin/ReportHSDetailtLHType/SearchColumnsChartGradationCompareForOneForDSChiNha?gradation=";
            chartGradation.dataSource.transport.options.read.data = '';
            chartGradation.dataSource.transport.options.read.url = urlChartDS + gradationDicID + "&year=" + toYear + "&reportTypeID=" + valueReportType + "&marketID=" + dataItem.Value;
            chartGradation.options.title.text = kendo.format("Doanh số từng dịch vụ từng thị trường \n Thị trường: {0} \n Giai đoạn: {1} {2}", dataItem.Text, $("#gradation").data("kendoComboBox").text(), toYear);
            ...
            urlChartDS = "/Admin/ReportHSDetailtLHType/SearchColumnsChartGradationCompareForOneForDSCK?gradation=";
            chartGradation.dataSource.transport.options.read.data = '';
            chartGradation.dataSource.transport.options.read.url = urlChartDS + gradationDicID + "&year=" + toYear + "&reportTypeID=" + valueReportType + "&marketID=" + dataItem.Value;
            chartGradation.options.title.text = kendo.format("Doanh số từng dịch vụ từng thị trường \n Thị trường: {0} \n Giai đoạn: {1} {2}", dataItem.Text, $("#gradation").data("kendoComboBox").text(), toYear);
            ...
            let urlChartPie = "/Admin/ReportHSDetailtLHType/SearchDataGradationComparePieYear?gradation=";
            ...
            let urlChartPieLastYear = "/Admin/ReportHSDetailtLHType/SearchDataGradationComparePieLastYear?gradation=";
    ...
    this.onSelectMarketForOneForMonth = function (e) {
        ...
        if (dataItem != null) {
            ...
            if ((fromDate.getFullYear() == toDate.getFullYear() && fromDate.getFullYear() == toDate.getFullYear())
                ...
                let urlGrid = "/Admin/ReportHSDetailtLHType/SearchMarketForOneForMonth?fromDate=";
                grid.dataSource.transport.options.read.data = '';
    ...
    this.onSelectMarketForOneForYear = function (e) {
        ...
        if (dataItem != null) {
            ...
            if (toYear.getFullYear() - fromYear.getFullYear() <= 4) {
                ...
                let urlGrid = "/Admin/ReportHSDetailtLHType/SearchMarketForOneForYear?fromDate=";
                grid.dataSource.transport.options.read.data = '';
