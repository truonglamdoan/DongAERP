...
namespace DongAERP.Areas.Admin.Controllers
{
    public class ReportHSDetailtPartnerLTController : Controller
    {
        ...
        {
            List<ReportDetailtForTotalMoneyType> listData = new HSReportBL().SearchReportDetailtPartnerLTForMonth(fromDate, toDate, reportTypeID);
        ...
        {
            List<ReportDetailtForTotalMoneyType> listData = new HSReportBL().SearchReportDetailtPartnerLTForYear(fromDate, toDate, reportTypeID);
        ...
        {
            string nameUrl = "Báo cáo chi tiết/Theo hồ sơ chi trả/Theo loại tiền/Loại hình dịch vụ/Từng đối tác";
            ViewBag.NameURL = nameUrl;
        ...
        {
            List<ReportDetailtForTotalMoneyType> listData = new HSReportBL().SearchPartnerLTForOne(fromDay, toDay, reportTypeID, partnerID);
        ...
        {
            List<ReportDetailtForTotalMoneyType> listDataConvert = new HSReportBL().SearchPartnerLTForOne(fromDay, toDay, reportTypeID, partnerID);
        ...
        {
            string nameUrl = "Báo cáo chi tiết/Theo hồ sơ chi trả/Theo thị trường/Loại hình dịch vụ/Từng đối tác";
            ViewBag.NameURL = nameUrl;
        ...
        {
            List<ReportDetailtForTotalMoneyType> listData = new HSReportBL().SearchPartnerLTForOneForMonth(fromDate, toDate, reportTypeID, partnerID);
        ...
        {
            List<ReportDetailtForTotalMoneyType> listDataConvert = new HSReportBL().SearchPartnerLTForOneForMonth(fromDate, toDate, reportTypeID, partnerID);
        ...
        {
            List<ReportDetailtForTotalMoneyType> listData = new HSReportBL().SearchPartnerLTForOneForYear(fromDate, toDate, reportTypeID, partnerID);
        ...
        {
            List<ReportDetailtForTotalMoneyType> listDataConvert = new HSReportBL().SearchPartnerLTForOneForYear(fromDate, toDate, reportTypeID, partnerID);
        ...
        {
            List<ReportDetailtForTotalMoneyType> listDataGradationConvert = new HSReportBL().ReportDetailtPartnerLTGradationCompareForOne(year, gradation, reportTypeID, partnerID);
        ...
        {
            List<ReportDetailtForTotalMoneyType> listDataGradation = new HSReportBL().ReportDetailtPartnerLTGradationCompareForOne(year, gradation, reportTypeID, partnerID);
        ...
        {
            List<ReportDetailtForTotalMoneyType> listDataGradationConvert = new HSReportBL().ReportDetailtPartnerLTGradationCompareForOne(year, int.Parse(gradation), reportTypeID, partnerID);
