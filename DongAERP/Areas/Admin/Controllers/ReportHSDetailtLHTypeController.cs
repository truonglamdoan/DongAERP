...
{
    public class ReportHSDetailtLHTypeController : Controller
    {
        // GET: Admin/ReportHSDetailtLHType
        ...
        {
            string nameUrl = "Báo cáo chi tiết/Theo hồ sơ chi trả/Theo thị trường/Loại hình dịch vụ/Tất cả";
            if (marketID.Contains("1"))
            {
                nameUrl = "Báo cáo chi tiết/Theo hồ sơ chi trả/Theo thị trường/Loại hình dịch vụ/Thị trường Châu Á";
            }
        ...
        {
            List<ReportDetailtSTMarket> listData = new HSReportBL().SearchMarketForTotalForDay(fromDay, toDay, reportTypeID, marketID);
        ...
        ///     [Truong Lam]   Created [10/06/2020]
        /// </history>
        public ActionResult SearchMarketForTotalForMonth([DataSourceRequest]DataSourceRequest request, DateTime fromDay, DateTime toDay, string reportTypeID, string marketID)
        {
            List<ReportDetailtSTMarket> listData = new HSReportBL().SearchMarketForTotalForMonth(fromDay, toDay, reportTypeID, marketID);
        ...
        ///     [Truong Lam]   Created [10/06/2020]
        /// </history>
        public ActionResult SearchMarketForTotalForYear([DataSourceRequest]DataSourceRequest request, DateTime fromDay, DateTime toDay, string reportTypeID, string marketID)
        {
            List<ReportDetailtSTMarket> listData = new HSReportBL().SearchMarketForTotalForYear(fromDay, toDay, reportTypeID, marketID);
        ...
        {
            List<ReportDetailtServiceType> listData = new HSReportBL().SearchMarketForOne(fromDay, toDay, reportTypeID, marketID);
            int count = 1;
        ...
        /// <summary>
        /// Search report day theo tháng nhập vào
        /// </summary>
        /// <returns></returns>
        /// <history>
        ///     [Truong Lam]   Created [10/06/2020]
        ...
        {
            List<ReportDetailtServiceType> listData = new HSReportBL().SearchMarketForOneforMonth(fromDate, toDate, reportTypeID, marketID);
            int count = 1;
            List<string> listDataMarket = new List<string>();
        ...
        {
            List<ReportDetailtServiceType> listData = new HSReportBL().SearchMarketForOneForYear(fromDate, toDate, reportTypeID, marketID);
            int count = 1;
            List<string> listDataMarket = new List<string>();
        ...
        {
            string nameUrl = "Báo cáo chi tiết/Theo hồ sơ chi trả/Theo thị trường/Loại hình dịch vụ/So Sánh/Giai đoạn - Tất cả";
            if (marketID.Contains("1"))
            {
                nameUrl = "Báo cáo chi tiết/Theo hồ sơ chi trả/Theo thị trường/Loại hình dịch vụ/So Sánh/Giai đoạn - Thị trường Châu Á";
            }
            ViewBag.NameURL = nameUrl;
            // Khởi tạo datatable
        ...
        {
            List<ReportDetailtServiceType> listDataGradation = new HSReportBL().ReportDetailtGradationCompareForAll(year, gradation, reportTypeID, marketID);
            ...
            else
            {
                ...
                foreach (string item in listMarket)
                {
                    ...
                    List<ReportDetailtServiceType> dataItemYear = listDataGradation.Where(x => x.MarketName == item && x.Year == (year - 1).ToString()).ToList();
        ...
        {
            List<ReportDetailtServiceType> listDataGradation = new HSReportBL().ReportDetailtGradationCompareForAllPercent(year, gradation, reportTypeID, marketID);
        ...
        {
            string nameUrl = "Báo cáo chi tiết/Theo hồ sơ chi trả/Theo thị trường/Loại hình dịch vụ/So sánh/Giai đoạn - Từng thị trường";
            ViewBag.NameURL = nameUrl;
            // Khởi tạo datatable
            DataTable table = new DataTable();
            // Tạo các cột cho datatable
        ...
        {
            List<ReportDetailtServiceType> listDataGradation = new HSReportBL().ReportDetailtGradationCompareForOne(year, gradation, reportTypeID, marketID);
        ...
        {
            List<ReportDetailtServiceType> listDataGradation = new HSReportBL().ReportDetailtGradationCompareForOnePercent(year, gradation, reportTypeID, marketID);
        ...
        {
            string nameUrl = "Báo cáo chi tiết/Theo hồ sơ chi trả/Theo thị trường/Loại hình dịch vụ/So Sánh/Tháng - Tất cả";
            if (marketID.Contains("1"))
            {
                nameUrl = "Báo cáo chi tiết/Theo hồ sơ chi trả/Theo thị trường/Loại hình dịch vụ/So Sánh/Tháng - Thị trường Châu Á";
            }
            ViewBag.NameURL = nameUrl;
            // Khởi tạo datatable
            DataTable table = new DataTable();
        ...
        {
            List<ReportDetailtSTMarket> listDataCompareMonth = new HSReportBL().ColumnChartStackCompareMonthForAllPercent(year, month, reportTypeID, marketID);
        ...
        {
            string nameUrl = "Báo cáo chi tiết/Theo hồ sơ chi trả/Theo thị trường/Loại hình dịch vụ/So sánh/Tháng - Từng thị trường";
            ViewBag.NameURL = nameUrl;
            // Khởi tạo datatable
            DataTable table = new DataTable();
            // Tạo các cột cho datatable
