...
{
    public class ReportExcelForTotalPaymentController : Controller
    {
        /// <summary>
        ...
        // GET: Admin/ReportExcelForTotalPayment
        ...
        public ActionResult CreateExcelForGradationCompare(string gradation, int year, string reportTypeID)
        {
            ...
            List<ReportForTotalPayment> listReportData = new ReportBL().DataReportTPForGradationCompare(year, int.Parse(gradation), reportTypeID);
