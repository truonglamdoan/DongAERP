...
{
    public class ReportHSMarketExcelController : Controller
    {
        /// <summary>
        ...
        public ActionResult CreateExcelForDayMonthYear(DateTime fromDate, DateTime toDate, int typeID, string reportTypeID)
        {
            ...
            string templatePath = "~/Content/Report/ReportHS/ReportHSMakets.xlsx";
            // Get đường dẫn
            ...
            switch (typeID)
            {
                // Theo ngày
                case 1:
                    listReportData = new HSReportBL().SearchReportMaketForDay(fromDate, toDate, reportTypeID);
                ...
                // Theo tháng
                case 2:
                    listReportData = new HSReportBL().SearchReportMaketForMonth(fromDate, toDate, reportTypeID);
                    // Set from day and to day
                ...
                // Theo năm
                default:
                    listReportData = new HSReportBL().SearchReportMaketForYear(fromDate, toDate, reportTypeID);
                    // Set from day and to day
        ...
        {
            WorkbookDesigner designer = new WorkbookDesigner();
            string templatePath = "~/Content/Report/ReportHS/ReportHSMaketGradationCompare.xlsx";
            // Get đường dẫn
            templatePath = System.Web.HttpContext.Current.Server.MapPath(templatePath);
            ...
            List<ReportForMaket> listReportData = new HSReportBL().SearchReportMaketForGradationCompare(year, int.Parse(gradationID), reportTypeID);
            // clone Object
            List<ReportForMaket> listReportDataClone = new List<ReportForMaket>(listReportData);

            List<ReportForMaket> listReportDataPercent = new HSReportBL().SearchReportMaketForGradationComparePercent(year, int.Parse(gradationID), reportTypeID);
            // clone Object
        ...
        public ActionResult CreateExcelForCompareYear(int year, int month, string reportTypeID)
        {
            ...
            List<ReportForMaket> listReportData = new HSReportBL().SearchReportMaketForCompareForMonth(year, month, reportTypeID);
            // clone Object
            List<ReportForMaket> listReportDataClone = new List<ReportForMaket>(listReportData);

            List<ReportForMaket> listReportDataPercent = new HSReportBL().SearchReportMaketForCompareMonthPercent(year, month, reportTypeID);
            // clone Object
            List<ReportForMaket> listReportDataPercentClone = new List<ReportForMaket>(listReportDataPercent);
