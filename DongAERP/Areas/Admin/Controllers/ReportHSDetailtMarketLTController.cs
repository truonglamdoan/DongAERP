...
{
    public class ReportHSDetailtMarketLTController : Controller
    {
        // GET: Admin/ReportHSDetailtMarketLT
        ...
        {
            string nameUrl = "Báo cáo chi tiết/Theo Hồ sơ chi trả/Theo thị trường/Loại tiền/Tất cả";
            if (marketID.Contains("1"))
            {
                nameUrl = "Báo cáo chi tiết/Theo Hồ sơ chi trả/Theo thị trường/Loại tiền/Thị trường Châu Á";
            }
        ...
        {
            List<ReportDetailtForTotalMoneyType> listData = new HSReportBL().SearchReportDetailtMTForAll(fromDay, toDay, reportTypeID, marketID);
        ...
        {
            List<ReportDetailtForTotalMoneyType> listData = new HSReportBL().SearchReportDetailtMTForAllForMonth(fromDate, toDate, reportTypeID, marketID);
        ...
        {
            List<ReportDetailtForTotalMoneyType> listData = new HSReportBL().SearchReportDetailtMTForAllForYear(fromDate, toDate, reportTypeID, marketID);
        ...
        {
            string nameUrl = "Báo cáo chi tiết/Theo Hồ sơ chi trả/Theo thị trường/Loại tiền chi trả/Từng thị trường";
            ViewBag.NameURL = nameUrl;
        ...
        {
            List<ReportDetailtForTotalMoneyType> listData = new HSReportBL().SearchReportDetailtMTForOne(fromDay, toDay, reportTypeID, marketID);
        ...
        {
            string nameUrl = "Báo cáo chi tiết/Theo Hồ sơ chi trả/Theo thị trường/Loại hình tiền/Từng thị trường";
            ViewBag.NameURL = nameUrl;
        ...
        {
            List<ReportDetailtForTotalMoneyType> listData = new HSReportBL().SearchReportDetailtMTForOneForMonth(fromDate, toDate, reportTypeID, marketID);
        ...
        {
            List<ReportDetailtForTotalMoneyType> listData = new HSReportBL().SearchReportDetailtMTForOneForYear(fromDate, toDate, reportTypeID, marketID);
        ...
        {
            string nameUrl = "Báo cáo chi tiết/Theo Hồ sơ chi trả/Theo thị trường/Loại tiền chi trả/So sánh - Giai đoạn - Tất cả thị trường";
            if (marketID.Equals("1"))
            {
                nameUrl = "Báo cáo chi tiết/Theo Hồ sơ chi trả/Theo thị trường/Loại tiền chi trả/So sánh - Giai đoạn - Thị trường Châu Á";
            }
            ViewBag.NameURL = nameUrl;
            ViewBag.NameURL = nameUrl;
            // Khởi tạo datatable
        ...
        {
            List<ReportDetailtForTotalMoneyType> listDataGradation = new HSReportBL().ReportDetailtMTGradationCompareForAll(year, gradation, reportTypeID, marketID);
        ...
        {
            List<ReportDetailtForTotalMoneyType> listDataGradation = new HSReportBL().ReportDetailtMTGradationCompareForAllPercent(year, gradation, reportTypeID, marketID);
        ...
        {
            string nameUrl = "Báo cáo chi tiết/Theo Hồ sơ chi trả/Theo thị trường/Loại tiền chi trả/So sánh - Giai đoạn - Từng thị trường";
            ViewBag.NameURL = nameUrl;
            // Khởi tạo datatable
            DataTable table = new DataTable();
            // Tạo các cột cho datatable
        ...
        {
            List<ReportDetailtForTotalMoneyType> listDataGradation = new HSReportBL().ReportDetailtMTGradationCompareForOne(year, gradation, reportTypeID, marketID);
        ...
        {
            List<ReportDetailtForTotalMoneyType> listDataGradation = new HSReportBL().ReportDetailtMTGradationCompareForOnePercent(year, gradation, reportTypeID, marketID);
        ...
        {
            string nameUrl = "Báo cáo chi tiết/Theo Hồ sơ chi trả/Theo thị trường/Loại tiền chi trả/So sánh - Theo tháng - Tất cả thị trường";
            if (marketID.Equals("1"))
            {
                nameUrl = "Báo cáo chi tiết/Theo Hồ sơ chi trả/Theo thị trường/Loại tiền chi trả/So sánh - Theo tháng - Thị trường Châu Á";
            }
            ViewBag.NameURL = nameUrl;
            // Khởi tạo datatable
            DataTable table = new DataTable();
        ...
        {
            List<ReportDetailtForTotalMoneyType> listDataCompareMonth = new HSReportBL().ColumnChartStackDetailtMTCompareMonthForAllPercent(year, month, reportTypeID, marketID);
        ...
        {
            string nameUrl = "Báo cáo chi tiết/Theo Hồ sơ chi trả/Theo thị trường/Loại tiền chi trả/So sánh - Theo tháng - Từng thị trường";
            ViewBag.NameURL = nameUrl;
            // Khởi tạo datatable
            DataTable table = new DataTable();
            // Tạo các cột cho datatable
        ...
        {
            List<ReportDetailtForTotalMoneyType> listDataCompareMonth = new HSReportBL().ReportDetailtMTCompareMonthForOneConvertPercent(year, month, reportTypeID, marketID);
            List<ReportDetailtForTotalMoneyType> listDataCompareMonthConvert = new List<ReportDetailtForTotalMoneyType>();
